class VehicleByIdModel {
  ...
  final String? status;
  final List<VehicleCar> data;

  factory VehicleByIdModel.fromJson(Map<String, dynamic> json){
    return VehicleByIdModel(
      status: json["status"],
      data: json["data"] == null ? [] : List<VehicleCar>.from(json["data"]!.map((x) => VehicleCar.fromJson(x))),
    );
  }
...
class VehicleCar {
  ...
  factory VehicleCar.fromJson(Map<String, dynamic> json){
    return VehicleCar(
      id: json["id"],
